...
var ajaxifyShopify = (function(module, $) {
  ...
  buildCart = function (cart) {
    ...
    if (cart.item_count === 0) {
      $cartContainer
        .append('<h3 class="uppercase h3">' + "Su carrito actualmente está vacío." + '</h3>')
        .append('<a href="/collections/all" class="btn btn--large btn--splash btn--full uppercase btn--checkout">' + "Continúe explorando aquí" + '</a>');
